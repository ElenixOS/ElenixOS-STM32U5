...
/* STM32U5 DMA2D acceleration for fills, blends and image copies. */
#define LV_USE_DRAW_DMA2D 0
#define LV_DRAW_DMA2D_HAL_INCLUDE "stm32u5xx_hal.h"
#define LV_USE_DRAW_DMA2D_INTERRUPT 0

/* STM32U5G9 GPU2D/NemaGFX hardware renderer. */
#define LV_USE_NEMA_GFX 1
#define LV_USE_NEMA_LIB 1 /* LV_NEMA_LIB_M33_REVC */
#define LV_USE_NEMA_HAL 1 /* LV_NEMA_HAL_STM32 */
#define LV_NEMA_STM32_HAL_INCLUDE <stm32u5xx_hal.h>
#define LV_USE_NEMA_VG 0
/* The STM32U5 GPU2D path currently has a font-source/cache issue. Keep glyph
 * rasterization on LVGL's optimized CPU path while retaining GPU fills and
 * image compositing. */
#define LV_NEMA_GFX_DISABLE_LABEL 0
